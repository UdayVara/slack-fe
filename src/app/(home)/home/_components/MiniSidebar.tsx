...
function MiniSidebar() {
  ...
  <HoverCardTrigger><Avatar className="cursor-pointer">
        <AvatarImage src="D" />
        <AvatarFallback>DS</AvatarFallback>
      </Avatar></HoverCardTrigger>
  <HoverCardContent side="right" align="end"  alignOffset={100} sideOffset={2}  className="bg-neutral-200 ml-4  p-0 text-black">
    <div className="py-2 px-2 cursor-pointer hover:bg-neutral-300">
      <h5>Demo Sample</h5>
      <p className=" text-neutral-700 text-sm">demosample.slack.com</p>
    </div>
    <div className="py-2 px-2 cursor-pointer hover:bg-neutral-300 ">
      <h5 className="flex flex-row  items-center gap-2"> <GoPlusCircle /> Create Workspace</h5>
